...
env.repository = 'git@github.com:eduherraiz/portofolio'
...
def prod():
    ...
    env.user_app = 'portfolio'
    env.port = 2232
    env.project_dir = '/var/pywww/portfolio'
    env.project_codedir = '/var/pywww/portfolio/code'
    env.virtualenv_dir = '/var/pywww/portfolio/.virtualenvs/portfolio'
